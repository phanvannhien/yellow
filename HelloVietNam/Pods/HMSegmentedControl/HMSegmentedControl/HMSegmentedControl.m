...
//        p3 = CGPointMake(self.selectionIndicatorArrowLayer.bounds.size.width, self.selectionIndicatorArrowLayer.bounds.size.height);
        ...
        [arrowPath moveToPoint:CGPointMake(0, 8)];
        [arrowPath addArcWithCenter:CGPointMake(8, 8) radius:8 startAngle:M_PI endAngle:0 clockwise:YES];
        [arrowPath closePath];
        CGAffineTransform scale = CGAffineTransformMakeScale(1, 1);
        [arrowPath applyTransform:scale];
